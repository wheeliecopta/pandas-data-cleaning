...
## Project Goal
This project revolves around the fictitious e-commerce retailer Eniac, specialized in high-end tech products. The goal is to use a data-driven approach to find out if discounts are beneficial for the company's revenue. The bulk of the project consists of cleaning up the retail data (collected from a real-world tech retailer) and making it interpretable for further analysis. 
<br><br>
